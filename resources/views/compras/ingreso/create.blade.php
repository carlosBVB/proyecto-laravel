    ...
    <div class="row">
       ...
       <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                ...
                <input type="date" name="fecha_hora" required value="{{old('fecha_hora')}}" class="form-control" placeholder="Número comprobante...">
            </div>
        </div>
    	<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
    		<div class="form-group">
    	...
    	<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="serie_comprobante" value="{{old('serie_comprobante')}}" class="form-control" placeholder="Serie comprobante..." onkeypress="mayus(this);" > 
            </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
                <label for="num_comprobante">Número Comprobante</label>
                <input type="number" name="num_comprobante" required value="{{old('num_comprobante')}}" class="form-control" placeholder="Número comprobante..." onkeypress="mayus(this);">
            </div>
        </div>
