    ...
    <div class="row">
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    		<div class="form-group">
            	...
            	<input type="text" name="nombre" required value="{{$articulo->nombre}}" class="form-control" onkeypress="mayus(this);">
            </div>
    	</div>
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    		<div class="form-group">
    	...
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    		<div class="form-group">
            	...
            	<input type="text" name="codigo" id="codigobar" required value="{{$articulo->codigo}}" class="form-control" onkeypress="mayus(this);">
