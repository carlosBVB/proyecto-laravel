    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>SIS Inventario</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li id="liAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li id="liEntregas"><a href="{{url('almacen/entrega')}}"><i class="fa fa-circle-o"></i> Asignaciones</a></li>
              </ul>
            </li>
            ...
            <li id="lipersonal" class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li id="liempleado"><a href="{{url('personal/empleados')}}"><i class="fa fa-circle-o"></i> Empleados</a></li>
            ...
            <li id="liVentas" class="treeview">
             ...
             <li id="liReportes" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="liRepor"><a href="{{url('reportes')}}"><i class="fa fa-circle-o"></i>Reportes</a></li>
              </ul>
