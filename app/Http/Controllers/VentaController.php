...
class VentaController extends Controller
{
     ...
     public function store (VentaFormRequest $request)
    {
    	try{
	        ...
	        $mytime = Carbon::now('America/Central');
    ...
    public function reportec($id){
        ...
        $pdf::SetXY(187,153);
        $pdf::MultiCell(20,0,"Lps/. ".sprintf("%0.2F", $venta->total_venta-($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,160);
        $pdf::MultiCell(20,0,"Lps/. ".sprintf("%0.2F", ($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,167);
        $pdf::MultiCell(20,0,"Lps/. ".sprintf("%0.2F", $venta->total_venta));
    ...
    public function reporte(){
     ...
     public function rventas(){
         ...
         $registros=DB::table('venta as v')
            ...
            ->where('v.fecha_hora','>=', $_GET["fecha_inicial"])
            ->where('v.fecha_hora','<=', $_GET["fecha_final"])
